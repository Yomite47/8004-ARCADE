...
const DEST_BASE = path.join(__dirname, '../public/split_images');
...
async function splitImages() {
    ...
    // Create destination base if not exists
    ...
    // Sort files numerically to ensure 1.png, 2.png... not 1.png, 10.png
    files.sort((a, b) => {
    ...
    console.log(`\n✅ Successfully split ${files.length} images into ${batchCount} batches.`);
